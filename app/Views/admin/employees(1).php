                ...
                <div class="modal-body">
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="email" class="form-control" name="email" placeholder="kovacs@pelda.hu" required maxlength="150">
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-12">
                            ...
                            <div class="password-wrapper">
                                <input type="password" class="form-control pe-5" id="add_password" name="password" placeholder="Min. 8 karakter" required minlength="8">
            ...
            <form method="POST" action="/admin/employees/update" novalidate autocomplete="off">
                ...
                <div class="modal-body">
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            <label class="form-label fw-semibold">E-mail cim <span class="text-danger">*</span></label>
                            <input type="email" class="form-control" name="email" id="edit_email" required maxlength="150">
                        </div>
                        <div class="col-md-6">
                            <label class="form-label fw-semibold">Telefon</label>
                        ...
                        <div class="col-12">
                            ...
                            <div class="password-wrapper">
                                <input type="password" class="form-control pe-5" id="edit_password" name="password" placeholder="Min. 8 karakter">
